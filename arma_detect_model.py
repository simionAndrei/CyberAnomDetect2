...
class ArmaDetectModel:
    ...
    def __init__(self, logger):
        ...
        # parameters deduced from the analysis found in `Arma-results.ipynb`
    ...
    def _read_data(self):
        ...
        # store the attack location for fast lookup
        self.test_attacks_location = np.where(self.df_test['ATT_FLAG'] == 1)

    # computes the metadata interesting for the model
    def _compute_stats(self, series, signal_name, model):
        # get the true values of the points
        ...
        # calculate the std with a 24 entries moving window
    ...
    # calculate the optimal threshold parameters
